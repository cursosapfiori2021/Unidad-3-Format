					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Controles de IU",
									"targetURL": "#nscontroles-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"nscontroles-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.controles",
									"url": sap.ui.require.toUrl("ns/controles")
								}
							}
						}
					}
